<template>
    <div class="error-page">
        ...
        <div class="container" ref="container">
            ...
            <h1 class="error-message">Erreur interne du serveur</h1>
            <p class="error-description">
                Quelque chose s'est mal passé de notre côté. Nos équipes travaillent à résoudre le problème.
            </p>
...
onMounted(() => {
    ...
    if (container.value) {
        container.value.style.transform = 'scale(0.8)'
        container.value.style.opacity = '0'
        
        setTimeout(() => {
            container.value.style.transition = 'all 0.8s ease-out'
...
.error-code {
    font-size: 12rem;
    font-weight: 900;
    background: linear-gradient(45deg, #87ceeb, #5f9ea0, #add8e6, #b0e0e6);
...
.shape-3 {
    ...
    border-bottom: 70px solid #b0e0e6;
}
